...
MACRO_CONFIG_STR(TcForcedSkinBody1, tc_forced_skin_body1, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin body for red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkinTattoo1, tc_forced_skin_tattoo1, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin for tattoo red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkinDecoration1, tc_forced_skin_decoration1, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin decoration for red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkinHands1, tc_forced_skin_hands1, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin hands for red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkinFeet1, tc_forced_skin_feet1, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin feet for red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkinEyes1, tc_forced_skin_eyes1, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin eyes for red/mates/DM matchs")
MACRO_CONFIG_STR(TcForcedSkin2, tc_forced_skin2, 64, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin for blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinBody2, tc_forced_skin_body2, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin body for blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinTattoo2, tc_forced_skin_tattoo2, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin for tattoo blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinDecoration2, tc_forced_skin_decoration2, 24, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin decoration for blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinHands2, tc_forced_skin_hands2, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin hands for blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinFeet2, tc_forced_skin_feet2, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin feet for blue/opponents")
MACRO_CONFIG_STR(TcForcedSkinEyes2, tc_forced_skin_eyes2, 24, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Forced skin eyes for blue/opponents")
