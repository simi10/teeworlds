...
bool CScoreboard::Active()
{
	...
	// if the game is over
	if(m_pClient->m_Snap.m_pGameInfoObj && m_pClient->m_Snap.m_pGameInfoObj->m_GameStateFlags&(GAMESTATEFLAG_ROUNDOVER|GAMESTATEFLAG_GAMEOVER) && Client()->State() != IClient::STATE_DEMOPLAYBACK)
		return true;
