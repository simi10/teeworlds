...
{
	char aBuf[128];
	CUIRect Label, Button, Left, Right, Game, Client, Language, List;
...
void CMenus::RenderSettingsTee(CUIRect MainView)
{
	...
	CUIRect YourSkin, Preview, CustomizeSkin, Left, Right, Mid, SaveSkin, Selection, UCC, Picker;
...
void CMenus::RenderSettingsControls(CUIRect MainView)
{
	...
	// defaults
	{
		...
		if(Client()->State() != IClient::STATE_ONLINE)
			...
			ResetButton.HMargin(12.0f, &ResetButton);
