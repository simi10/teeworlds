...
container.sprites.Add(Sprite("browsericon_refresh", set_browsericons, 0,0,1,1))
container.sprites.Add(Sprite("browsericon_lock", set_browsericons, 1,0,1,1))
container.sprites.Add(Sprite("browsericon_tee", set_browsericons, 2,0,1,1))
container.sprites.Add(Sprite("browsericon_collapse", set_browsericons, 3,0,1,1))
container.sprites.Add(Sprite("browsericon_expand", set_browsericons, 4,0,1,1))
container.sprites.Add(Sprite("browsericon_close", set_browsericons, 5,0,1,1))
container.sprites.Add(Sprite("browsericon_edit", set_browsericons, 6,0,1,1))
container.sprites.Add(Sprite("browsericon_down", set_browsericons, 7,0,1,1))
container.sprites.Add(Sprite("browsericon_up", set_browsericons, 8,0,1,1))
container.sprites.Add(Sprite("browsericon_info", set_browsericons, 9,0,1,1))
container.sprites.Add(Sprite("browsericon_star_active", set_browsericons, 10,0,1,1))
container.sprites.Add(Sprite("browsericon_star_inactive", set_browsericons, 11,0,1,1))
